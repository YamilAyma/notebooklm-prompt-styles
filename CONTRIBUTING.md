...
![Modern Dark Preview](public/preview/modern_dark/modern_dark_1.png)
...
We follow a strict commit message format in **Spanish**.
...
```bash
git add .
git commit -m "feat (Styles) - Agregar estilo Modern Dark"
```
...
- [ ] Commit message is in **Spanish** and follows the convention.
